                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="intitule" id="inIntitule" placeholder="Intitule " value="<?php echo $questionnaire->INTITULE;?>" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control" name="typeq" id="typeq" size="1" required>
                                <option <?php if($questionnaire->TYPEQ=="QCU") echo 'selected="selected"'; ?> value="QCU">QCU</option>
                                <option <?php if($questionnaire->TYPEQ=="QCM") echo 'selected="selected"'; ?> value="QCM">QCM</option>
                                <option <?php if($questionnaire->TYPEQ=="QRL") echo 'selected="selected"'; ?> value="QRL">QRL</option>
                            </select>
                            <div class="valid-feedback">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" name="temps_max" id="inTemps_max" value="<?php echo $questionnaire->TEMPS_MAXIMAL;?>" placeholder="MM">
                            <div class="valid-feedback">
                                Saisir une durée!
                            </div>
                            <!-- fin bloc durée  -->

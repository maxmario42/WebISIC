...
CREATE TABLE `UTILISATEUR` (
  ...
  `ANNEE_DE_SORTIE` smallint(10) DEFAULT NULL,
...
--
ALTER TABLE `QUESTION`
  MODIFY `ID_QUEST` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `QUESTIONNAIRE`
--
ALTER TABLE `QUESTIONNAIRE`
  MODIFY `IDQ` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `REGLES_GENERATION`
--
ALTER TABLE `REGLES_GENERATION`
  MODIFY `ID_REGLE` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `REGLES_QUESTIONNAIRE`
--
ALTER TABLE `REGLES_QUESTIONNAIRE`
  MODIFY `ID_REGLES_QUEST` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `REPONSES_POSSIBLES`
--
ALTER TABLE `REPONSES_POSSIBLES`
  MODIFY `ID_REPONSE` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `REPONSE_CHOISIE`
--
ALTER TABLE `REPONSE_CHOISIE`
  MODIFY `IDRC` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `SPECIFIER`
  ADD CONSTRAINT `FK_SPECIFIER` FOREIGN KEY (`IDQ`) REFERENCES `QUESTIONNAIRE` (`IDQ`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_SPECIFIER2` FOREIGN KEY (`ID_REGLE`) REFERENCES `REGLES_GENERATION` (`ID_REGLE`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `TAGGER`
--
ALTER TABLE `TAGGER`
  ADD CONSTRAINT `FK_TAGGER` FOREIGN KEY (`ID_QUEST`) REFERENCES `QUESTION` (`ID_QUEST`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_TAGGER2` FOREIGN KEY (`TAG`) REFERENCES `TAG` (`TAG`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
